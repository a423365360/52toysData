...
public class FeiShu {
    ...
    public static void main(String[] args) throws IOException {
        ...
        String todayDate = DateTime.now().toDateStr();
        String dt = DateTime.now().offset(DateField.HOUR, -24).toDateStr();
        long end_time = DateTime.of(todayDate, "yyyy-MM-dd").getTime();
        long start_time = DateTime.of(todayDate, "yyyy-MM-dd").offset(DateField.HOUR, -24).getTime();
