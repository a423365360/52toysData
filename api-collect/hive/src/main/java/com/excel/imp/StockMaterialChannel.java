...
public class StockMaterialChannel implements ExcelSheet {
    SXSSFWorkbook xssfWorkbook;
    Connection hiveConnection;

    public StockMaterialChannel(SXSSFWorkbook xssfWorkbook, Connection hiveConnection) {
    ...
    public void setSheet(String table, String sql) throws Exception {
        ...
        rowField.createCell(2).setCellValue("渠道");
        ...
        while (resultSet.next()) {
            ...
            row.createCell(2).setCellValue(resultSet.getString("channel"));
